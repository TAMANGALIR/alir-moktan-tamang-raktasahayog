...
exports.updateRequestStatus = exports.getRequestsForAdmin = exports.getMyRequests = exports.createRequest = void 0;
...
exports.getRequestsForAdmin = getRequestsForAdmin;
        ...
        if (status === 'APPROVED') {
            ...
            await prisma.$transaction(async (tx) => {
                ...
                if (bloodUnit) {
                    ...
                    else if (bloodUnit.guestEmail) {
                        // TODO: Integrate actual Email Service here
                        console.log(`[Email Notification] Sending "You saved a life" email to guest: ${bloodUnit.guestEmail}`);
                    }
                }
