...
exports.getDashboardStats = exports.verifyOrganization = exports.getAllOrgs = exports.registerOrganization = void 0;
...
const registerOrganization = async (req, res) => {
    try {
        ...
        await (0, email_utils_1.sendEmail)(email, "Organization Registration Received - Raktasahayog", `<p>Dear ${name},</p>
    ...
    try {
        ...
        if (status === 'VERIFIED') {
            ...
            if (adminProfile) {
                ...
                // Send approval email
                await (0, email_utils_1.sendEmail)(adminProfile.user.email, "Organization Approved - Raktasahayog", `<p>Dear ${org.name},</p>
        ...
        if (status === 'REJECTED' && org.contactInfo) {
            if (org.contactInfo.includes('@')) {
                await (0, email_utils_1.sendRejectionEmail)(org.contactInfo, org.name, rejectionReason || 'Documentation issues');
            }
        }
