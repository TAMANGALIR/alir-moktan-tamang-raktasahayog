...
exports.getOrgAppointments = exports.updateAppointmentStatus = exports.getBookingOptions = exports.getMyAppointments = exports.createAppointment = void 0;
...
const createAppointment = async (req, res) => {
    try {
        ...
        const io = (0, socket_utils_1.getIO)();
        if (organizationId) {
...
const updateAppointmentStatus = async (req, res) => {
    try {
        ...
        if (status === 'COMPLETED') {
            ...
            if (donorProfile) {
                ...
                await prisma.donorProfile.update({
                    ...
                    data: {
                        ...
                        badge: newBadge // Cast to any until Client regenerates fully
                    }
                });
            }
            ...
            await (0, email_utils_1.sendEmail)(appointment.user.email, 'Thank You for Your Donation - Raktasahayog', `<p>Dear ${appointment.user.name},</p>
        ...
        // 2. CANCELED: Email
        if (status === 'CANCELED') {
            await (0, email_utils_1.sendEmail)(appointment.user.email, 'Appointment Canceled - Raktasahayog', `<p>Dear ${appointment.user.name},</p>
        ...
        // 3. REJECTED: Email
        if (status === 'REJECTED') {
            await (0, email_utils_1.sendEmail)(appointment.user.email, 'Appointment Request Rejected - Raktasahayog', `<p>Dear ${appointment.user.name},</p>
        ...
        if (status === 'APPROVED' || status === 'RESCHEDULED') {
            ...
            await (0, email_utils_1.sendEmail)(appointment.user.email, title, `<p>Dear ${appointment.user.name},</p>
...
exports.getOrgAppointments = getOrgAppointments;
